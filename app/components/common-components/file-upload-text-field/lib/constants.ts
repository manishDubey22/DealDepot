...
export const CONTAINER_PADDING_HORIZONTAL = 10

export const BORDER_RADIUS = 5

export const CONTAINER_MARGIN_TOP = 23

export const IMAGE_WIDTH = 20.4

export const IMAGE_HEIGHT = 21

export const FILE_TEXT_PADDING_LEFT = 5
